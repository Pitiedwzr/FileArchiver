...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.skipButton = QPushButton(Dialog)
        ...
        self.gridLayout.addWidget(self.skipButton, 3, 3, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", "Register", None))
        self.skipButton.setText(QCoreApplication.translate("Dialog", "Skip", None))
