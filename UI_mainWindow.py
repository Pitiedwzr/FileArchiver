...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"File Archiver", None))
        self.actionFile_Archiver_Help.setText(QCoreApplication.translate("MainWindow", u"File Archiver Help", None))
        self.actionAbout.setText(QCoreApplication.translate("MainWindow", u"About", None))
        self.actionLoad_snapshot.setText(QCoreApplication.translate("MainWindow", u"Load snapshot", None))
        ...
        self.actionChinese_CN.setText(QCoreApplication.translate("MainWindow", u"Chinese (CN)", None))
        self.pendingSelectButton.setText(QCoreApplication.translate("MainWindow", u"...", None))
        self.pendingPathLabel.setText(QCoreApplication.translate("MainWindow", u"Pending Path", None))
        self.processedSelectButton.setText(QCoreApplication.translate("MainWindow", u"...", None))
        self.processedPathLabel.setText(QCoreApplication.translate("MainWindow", u"Processed Path", None))
        self.pendingListLabel.setText(QCoreApplication.translate("MainWindow", u"Pending Files", None))
        self.processedListLabel.setText(QCoreApplication.translate("MainWindow", u"Processed Files", None))
        self.processButton.setText(QCoreApplication.translate("MainWindow", u"Process", None))
        self.snapshotCheckBox.setText(QCoreApplication.translate("MainWindow", u"Save snapshot", None))
